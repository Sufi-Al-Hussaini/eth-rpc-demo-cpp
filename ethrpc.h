...
#ifndef JSONRPC_CPP_STUB_ETHRPC_H_
#define JSONRPC_CPP_STUB_ETHRPC_H_

#include <jsonrpccpp/client.h>

class EthRpc : public jsonrpc::Client
{
    public:
        EthRpc(jsonrpc::IClientConnector &conn, jsonrpc::clientVersion_t type = jsonrpc::JSONRPC_CLIENT_V2) : jsonrpc::Client(conn, type) {}
...
#endif //JSONRPC_CPP_STUB_ETHRPC_H_
